...
<section id="one">
    <div class="inner">
        ...
        <p>Below we have some highlights of the cooperative profiles that we've taken.  Browse the videos below or check out all our spotlights on our Stories Page.  And don't forget to checkout the Trail Map if you'd like to find your way along the Trail Cooperative.</p>
	</div>
</section>
